...
import CompleteMonitoringDashboardService from "./services/completeMonitoringDashboardService.js";
...
const dcaProgressDashboardService =
  new DcaProgressDashboardService({
    tradingCycleRepository,
    dcaOrderRepository,
    marketPriceService,
  });

const capitalReservationDashboardService =
...
const tpSlStatusDashboardService =
  new TpSlStatusDashboardService({
    tradingCycleRepository,
    fillRepository,
    exchangeOrderRepository,
    positionCalculator,
...
const completeMonitoringDashboardService =
  new CompleteMonitoringDashboardService({
    botStatusService,
    exchangeOrderRepository,
